...
func (c *Controller) runWorker() {
	fmt.Println("Controller.runWorker: starting")

	// invoke processNextItem to fetch and consume the next change
	// to a watched or listed resource
	for c.processNextItem() {
		fmt.Println("Controller.runWorker: processing next item")
	}

	fmt.Println("Controller.runWorker: completed")
}
...
func (c *Controller) processNextItem() bool {
	fmt.Println("Controller.processNextItem: start")
